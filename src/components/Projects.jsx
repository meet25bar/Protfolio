...
const PROJECTS = [
  {
    ...
    longDesc:
      'Led development of a full-stack pet management platform, coordinating a team and driving application architecture decisions. Implemented JWT and Google OAuth authentication, Stripe payments, and REST APIs for multi-pet management. Optimized backend performance using Redis caching and rate limiting, with Docker and Kubernetes for containerized deployment.',
    tech: ['React', 'Node.js', 'Express', 'MongoDB', 'Redis', 'Docker', 'Kubernetes'],
    features: [
      ...
      { icon: Lock,       label: 'Multi-pet Management API' },
    ],
    image: imgPaw,
    color: 'rgb(99,179,237)',
    github: 'https://github.com/meet25bar',
    demo: 'https://paw-perfection.vercel.app/',
    metadata: 'Full-Stack · 2025-2026',
  },
  {
    id: 'kisansangam',
    title: 'KisanSangam',
    subtitle: 'AI-driven Crop Planning & Guidance',
    shortDesc: 'Smart agriculture application with 6-factor AI crop recommendation.',
    longDesc:
      'Engineered a 6-factor AI-driven crop recommendation workflow using soil, crop, location, season, climate, and market parameters for data-driven crop planning. Developed AI-powered farming guidance covering cultivation requirements, fertilizer recommendations, crop duration, and farming resources. Integrated Machine Learning and Generative AI capabilities into a smart agriculture application to support intelligent crop selection and farming decisions.',
    tech: ['Python', 'Machine Learning', 'Generative AI', 'RAG', 'REST APIs'],
    features: [
      { icon: Brain,    label: 'AI-driven Crop Recommendation' },
      { icon: Database, label: 'Generative AI & RAG' },
      { icon: Zap,      label: 'Farming Guidance Engine' },
    ],
    image: imgCrop,
